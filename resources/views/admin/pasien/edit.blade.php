                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="mb-3">
                            ...
                            <x-text-input id="nama" type="text" name="nama" :value="old('nama', $pasien->user->nama)"
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <x-text-input id="email" type="text" name="email" :value="old('email', $pasien->user->email)"
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <select class="form-select" name="jenis_kelamin">
                                <option @selected(old('jenis_kelamin', $pasien->jenis_kelamin) == '') disabled>-- pilih jenis kelamin --</option>
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <x-text-input id="no_telp" type="text" name="no_telp" :value="old('no_telp', $pasien->user->no_telp)"
